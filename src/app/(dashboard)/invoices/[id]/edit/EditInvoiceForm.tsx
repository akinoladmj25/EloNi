...
import type { Client, Invoice, InvoiceItem, Organisation } from '@/types'
...
export default function EditInvoiceForm({ invoice, org, clients }: EditInvoiceFormProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-5">
        <Link href={`/invoices/${invoice.id}`} className="inline-flex items-center gap-1 text-sm text-zinc-400 hover:text-zinc-700 transition-colors">
          <ChevronLeft size={14} />
          Back to invoice
        </Link>
      </div>
