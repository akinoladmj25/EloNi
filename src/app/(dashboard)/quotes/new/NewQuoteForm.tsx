...
export default function NewQuoteForm({ org, clients, defaultQuoteNumber }: NewQuoteFormProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      <div className="mb-5">
        <Link href="/quotes" className="inline-flex items-center gap-1 text-sm text-zinc-400 hover:text-zinc-700 transition-colors">
          <ChevronLeft size={14} />
          Quotes
        </Link>
      </div>
      ...
      <div className="space-y-3">
        <div className="bg-white rounded-xl p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <Link href="/clients/new" className="text-xs text-zinc-500 hover:text-zinc-800 mt-1 inline-block">+ Add new client</Link>
            </div>
            <div>
        ...
        <div className="flex gap-2 justify-end">
          <Link href="/quotes" className="inline-flex items-center h-9 px-4 rounded-md border border-zinc-200 text-sm text-zinc-600 hover:bg-zinc-50 transition-colors">
            Cancel
          </Link>
