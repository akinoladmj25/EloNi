...
interface SignupPageProps { searchParams: Promise<{ error?: string }> }
...
export default async function SignupPage({ searchParams }: SignupPageProps) {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-zinc-900 mb-1 tracking-tight">Create an account</h1>
      <p className="text-[13px] text-zinc-400 mb-8">Start invoicing clients in minutes.</p>
